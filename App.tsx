...
import { ProjectStackParamList, RootStackParamList, UserStackParamList } from "./navigation/types";
...
function User() {
    return (
        <UserTab.Navigator screenOptions={{ headerShown: false }} initialRouteName="Todo">
            <UserTab.Screen name="Todo" component={UserPage} options={{ headerShown: false }} />
