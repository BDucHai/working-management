  ...
  return (
    <View className="bg-white">
      <View className="pt-[50px] pb-[15px] px-[16px] bg-primary">
        <TouchableWithoutFeedback
          onPress={() => navigation.navigate("Project", { screen: "List" })}
        >
          <Ionicons
            className="ml-[20px]"
            name="arrow-back"
        ...
        <Text className="text-center font-bold text-[26px] text-white">
          {detailProject.name}
        </Text>
      </View>
      <SafeAreaView className=" bg-white">
        <View className="flex-row justify-between items-center mt-[28px] mx-[30px] border-b-[1px] border-[#15803d] pb-[8px] ">
          <View className="flex-row items-center">
            <Text className="mr-[5px] font-bold text-[22px] italic text-[#1F51FF]">
              Task
            </Text>
